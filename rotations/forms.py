...
#         self.fields['department_contact_position'].label = "Position of Contact Person in the Department"
...
#                   'department_contact_name', 'department_contact_position', 'department_email',
