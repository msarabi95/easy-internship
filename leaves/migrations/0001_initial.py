    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intern', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='leave_cancel_requests', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rotation_request', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='leave_requests', to='rotations.RotationRequest')),
            ],
        ),
        migrations.CreateModel(
